...
contract StrategyCommonChefBoostedLP is StratManager, FeeManager, GasThrottler {
    ...
    function chargeFees(address callFeeRecipient) internal {
        uint256 stakerFeeMils = IBoostStaker(boostStaker).stakerFee();
        uint256 totalFeeMils = stakerFeeMils.add(45);
        ...
        emit ChargedFees(callFeeAmount, beefyFeeAmount, strategistFeeAmount, stakerFeeAmount);
    }
