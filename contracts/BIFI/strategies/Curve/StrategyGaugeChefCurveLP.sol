...
contract StrategyGaugeChefCurveLP is StratManager, FeeManager, GasThrottler {
    ...
    function addLiquidity() internal {
        ...
        IRewardsGauge(want).deposit(poolBalance);
    }
    ...
    function _giveAllowances() internal {
        ...
        IERC20(poolToken).safeApprove(want, type(uint).max);
    ...
    function _removeAllowances() internal {
        ...
        IERC20(poolToken).safeApprove(want, 0);
